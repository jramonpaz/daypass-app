import { Animated, Image, ImageStyle, Pressable, StyleProp, StyleSheet, ViewStyle } from 'react-native';
...
const HeartIcon = (props: Props) => {
  ...
  return (
    <Pressable style={[styles.favotiteIconContainer, props.containerStyle]} onPress={handleOnChange}>
