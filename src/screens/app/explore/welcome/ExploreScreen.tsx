import { ActivityIndicator, Dimensions, SafeAreaView, ScrollView, StatusBar, StyleSheet, View } from 'react-native';
...
import { general_getNearbyHotels, general_searchGeneral } from '@app/store/slices/explore/explore.service';
...
const ExploreScreen = () => {
  ...
  useEffect(() => {
    ...
    dispatch(general_getNearbyHotels({
      lang: language,
          ...
          {loadingLocations ? (
            ...
            <View style={styles.listContainer}>
              {locations.map((location, idx) => {
                ...
                return (
                  <View key={location.id ?? Date.now()} style={styles.imgContainer} >
                    <ImageBgBtn
                      label={location.name}
                ...
                nearbyHotels.map((venue) => (
                  <HotelListItem
                    ...
                    onChangeFavorite={(favorite) =>
                      toggleFavoriteHotels(favorite, venue.id_venue)
                    }
