...
const SearchOptionsExplorer = (props: Props) => {
  ...
  const { searchPredictionList, isLoading, searchSelectedPrediction } = useAppSelector(state => state.search);
  ...
  return (
    <View style={styles.filterFieldContainer}>
      ...
      <Controller
        ...
        name="search"
      />
      {errors.search && <TextComponent size="12" color="primary">{errors.search.message}</TextComponent>}
      ...
      <Controller
        ...
        name="date"
      />
      {errors.date && <TextComponent size="12" color="primary">{errors.date.message}</TextComponent>}
      ...
      <Controller
        ...
        name="peoples"
      />
      {errors.peoples && <TextComponent size="12" color="primary">{errors.peoples.message}</TextComponent>}
      ...
      {searchPredictionList.length > 0 && (
        <View style={styles.listContainer}>
          <ListLocationSearch list={searchPredictionList} onSelectOne={handleSelectLocation} />
        </View>
      )}
    </View>
  );
