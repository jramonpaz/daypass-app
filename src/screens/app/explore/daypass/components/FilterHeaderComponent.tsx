	...
	return (
		<View style={styles.container}>
			<Pressable
				...
				<Image source={chevron_left__white_icon} style={styles.backIcon} />
			</Pressable>

			<View style={[styles.filterContainer, gStyles.shadow_6]}>
				{!props.date && (
					<Pressable style={styles.filterContentItem} onPress={props.onPressDate}>
						<Image source={calendar_outline_icon} style={styles.iconActive} />
				...
				{props.date && (
					<>
						...
						{/* <Pressable
							...
							<Image source={people_icon} style={styles.iconActive} />
