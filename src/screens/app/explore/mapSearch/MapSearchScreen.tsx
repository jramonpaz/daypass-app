...
const MapSearchScreen = () => {
  ...
  const {filtersCount, hotelStarTypes, vibesList, ticketsMoodList, priceRange} = useAppSelector(state => state.explore);
            ...
            <View style={styles.header}>
              <View style={styles.rowFilter}>
                ...
                <FilterComponent
                  ...
                  date={formatDate(searchFilterData ? parseDateStringToDate(searchFilterData.date_search) : new Date())}
              ...
              <FiltersAppliedContainer onChangeSomeFilter={handleChangeFilters} />
