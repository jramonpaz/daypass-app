...
export const viewer_venueGetDetailService = (payload: IGetVenueDetailsRequest) => async (dispatch: Dispatch) => {
  try {
...
export const viewer_venueGetTicketsService = (payload: IVenueTicketsRequest) => async (dispatch: Dispatch) => {
  try {
    dispatch(hotelActions.clean());
    dispatch(hotelActions.setIsLoading(true));
...
export const viewer_venueGetReviewsService = (payload: IGetVenueReviewsRequest) => async (dispatch: Dispatch) => {
  try {
    dispatch(hotelActions.clean());
    dispatch(hotelActions.setIsLoading(true));
...
export const userPurchaseCheckService = (payload: IPurchaseVenueCheckPayload) => async (dispatch: Dispatch) => {
  try {
    dispatch(hotelActions.clean());
    dispatch(hotelActions.setIsLoading(true));
...
export const getShoppingCartPurchaseService = (payload: IShoppingCartPurchaseRequest) => async (dispatch: Dispatch) => {
  try {
    dispatch(hotelActions.clean());
    dispatch(hotelActions.setIsLoading(true));
    ...
    if (status === 200 && data.result === 0) {
      ...
      dispatch(hotelActions.setError(t('hotels-service-shopping-cart-purchase-error')));
    }
  } catch (error) {
    console.error('Error getting shopping cart purchase', error);
    dispatch(hotelActions.setError(t('hotels-service-get-shopping-cart-purchase-error')));
  } finally {
    dispatch(hotelActions.setIsLoading(false));
  }
};

export const getShoppingCartPurchaseAnonymousService = (payload: IShoppingCartPurchaseAnonymousRequest) => async (dispatch: Dispatch) => {
  try {
    dispatch(hotelActions.clean());
    dispatch(hotelActions.setIsLoading(true));
...
export const executePurchaseUserService = (payload: IExecutePurchaseRequest) => async (dispatch: Dispatch) => {
  try {
    dispatch(hotelActions.clean());
    dispatch(hotelActions.setIsLoading(true));
    ...
    if (status === 200 && data && data.result === 0) {
      ...
      dispatch(hotelActions.setError(t('hotels-service-purchase-error-with-code', { code: data?.result })));
    }
...
export const executePurchaseAsAnonymousService = (payload: IExecutePurchaseAnonymousRequest) => async (dispatch: Dispatch) => {
  try {
    dispatch(hotelActions.clean());
    dispatch(hotelActions.setIsLoading(true));
