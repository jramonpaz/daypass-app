...
export const hotelSlice = createSlice({
  ...
  reducers: {
    ...
    setHotelVieweReviewsRequest: (state, action: PayloadAction<IGetVenueReviewsRequest | null>) => {
      state.hotelVieweReviewsRequest = action.payload;
    },
    // purchase
    setShoppingCartPurchase: (state, action: PayloadAction<IShoppingCartPurchaseResponse | null>) => {
      state.shoppingCartPurchase = action.payload;
    },
    setShoppingCartPurchaseAnonymous: (state, action: PayloadAction<IShoppingCartPurchaseResponse | null>) => {
      state.shoppingCartPurchaseAnonymous = action.payload;
    },
    setExecutePurchaseAnonymousRequest: (state, action: PayloadAction<IExecutePurchaseAnonymousRequest>) => {
    ...
    addPurchaseTickets: (state, action: PayloadAction<IPurchaseTicketDetail>) => {
      const isAllreadyAdded = state.purchaseTickets.find(t => t.id_venue_ticket === action.payload.id_venue_ticket);
      if (isAllreadyAdded) {
    ...
    removePurchaseTickets: (state, action: PayloadAction<IPurchaseTicketDetail>) => {
      state.purchaseTickets = state.purchaseTickets.filter(t => t.id_venue_ticket !== action.payload.id_venue_ticket);
    },
    setHotelVenuePurchaseResponse: (state, action: PayloadAction<IPurchaseVenueCheckResponse>) => {
    ...
    setHotelInMapSelected: (state, action: PayloadAction<IHotelListItem>) => {
      const hotelsFiltered = state.hotelsListFiltered.filter(hotel => hotel.id_venue !== action.payload.id_venue);
